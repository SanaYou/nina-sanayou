...
Goede verstaanbaarheid is essentieel voor de beoordeling. Controleer vooraf of instructies, uitleg en eventuele aanwijzingen helder te horen zijn.

## Aanleveren van de video

Lever je examenvideo('s) uiterlijk één week vóór de gereserveerde beoordelingsdatum aan. Je stuurt de video('s) per e-mail naar academy@sanayou.com met een onbeveiligde downloadlink, dus zonder wachtwoord of inlog. Gebruik daarvoor bij voorkeur WeTransfer, Google Drive of OneDrive. Zorg ervoor dat de link goed werkt en dat de video zonder beperkingen kan worden gedownload.

Houd er rekening mee dat wanneer de examenvideo('s) te laat worden aangeleverd, de beoordeling niet op de geplande datum kan plaatsvinden. In dat geval vervalt de afspraak.

## Aanvullende instructies

Naast deze algemene criteria ontvang je bij het aanvragen van het examen altijd aanvullende, specifieke instructies. Deze zijn leidend voor jouw examenopname.
